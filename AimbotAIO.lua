...
spellsconfig = menu:add_subcategory(game.local_player.champ_name .." settings", config)	
...
if not Champs[game.local_player.champ_name] then return end
 ...
 if Champs[game.local_player.champ_name] then
	for i, spells in pairs(Champs[game.local_player.champ_name]) do
		if spells.spell_name == spellbook:get_spell_slot(SLOT_Q).spell_data.spell_name then 
			spellmenuq = menu:add_keybinder("Q Key", spellsconfig, 81)
			spellmenu_enableq = menu:add_checkbox("Q Enabled", spellsconfig, 1)
		elseif spells.spell_name == spellbook:get_spell_slot(SLOT_W).spell_data.spell_name then 
			spellmenuw = menu:add_keybinder("W Key", spellsconfig, 87)
			spellmenu_enablew = menu:add_checkbox("W Enabled", spellsconfig, 1)
		elseif spells.spell_name == spellbook:get_spell_slot(SLOT_E).spell_data.spell_name then 
			spellmenue = menu:add_keybinder("E Key", spellsconfig, 69)
			spellmenu_enablee = menu:add_checkbox("E Enabled", spellsconfig, 1)
		elseif spells.spell_name == spellbook:get_spell_slot(SLOT_R).spell_data.spell_name then 
